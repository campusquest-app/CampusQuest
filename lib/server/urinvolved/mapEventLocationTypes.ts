...
export const URI_LOCATION_ALIASES: Record<string, UriAliasTarget> = {
  ...
  "thomas m ryan center": { name: "Ryan Center", latitude: 41.4865, longitude: -71.5298 },
  "soccer complex": { name: "URI Soccer Complex", latitude: 41.4838, longitude: -71.5348 },
  "tootell aquatic center": { name: "Tootell Aquatic Center", latitude: 41.485, longitude: -71.5292 },
  "tootell athletic center": { name: "Rec Center", latitude: 41.4849, longitude: -71.5288 },
